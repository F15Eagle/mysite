...
This massive influx of new members brought an unexpected leadership bottleneck: we suddenly had a highly enthusiastic but entirely inexperienced freshman cohort[cite: 2]. Balancing college applications, school, and rocket development left little room to design a formal training pipeline on the fly[cite: 2]. I chose to have newer members learn CAD and core aerospace concepts "on the go" to keep our production schedule alive[cite: 2]. 
